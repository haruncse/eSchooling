...
<head>
    <title>Collegian Education Category Bootstrap responsive Web Template | Services :: w3layouts</title>
                ...
                <nav class="top-overlay-content" id="nav">
                    ...
                    <div class="container" id="container">
                        <ul class="first-nav text-center">
                            ...
                            <li class="dropdown">
                              <button class="dropbtn active">Dropdown <i class="fas fa-angle-down"></i></button>
            ...
            <div class="inner-sec-wthree-w3ls py-md-5 py-4">
                <h3 class="tittle-w3l text-center mb-lg-5 mb-3">
                   ...
                   <div class="row mt-5">
                       ...
                       <div class="serve-grid col-lg-4 mt-lg-5">
                          <div class="row serve-gd-ingo">
                            <div class="col-md-3 s-icon text-center">
							<i class="fas fa-headphones"></i>
                            </div>
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Art Studio</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
						</div>
						...
						<i class="far fa-bell"></i>
                                ...
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Great Facility</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
                        ...
                        <div class="serve-grid col-lg-4 mt-lg-5">
                          <div class="row serve-gd-ingo">
							...
							<i class="fab fa-github"></i>
                                ...
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Activity Hub</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
                        ...
                        <div class="serve-grid col-lg-4 mt-lg-5">
                          <div class="row serve-gd-ingo">
							...
							<i class="fas fa-graduation-cap"></i>
                                ...
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Fully Qualified</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
                        ...
                        <div class="serve-grid col-lg-4 mt-lg-5">
                          <div class="row serve-gd-ingo">
							...
							<i class="far fa-chart-bar"></i>
                                ...
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Flexible Schedule</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
                        ...
                        <div class="serve-grid col-lg-4 mt-lg-5">
                          <div class="row serve-gd-ingo">
							...
							<i class="fas fa-flask"></i>
                                ...
                                <div class="col-md-9 s-info text-left">
                                        <h4 class="mb-lg-3 mb-3">Chemistry Lab</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore.
                                        </p>
                                </div>
                              </div>
...
<!--/events-->
    <section class="banner-bottom-w3layouts bg-light py-md-5 py-4">
        <div class="container">
            <div class="inner-sec-wthree-w3ls py-md-5 py-4">
                <h3 class="tittle-w3l text-center mb-lg-5 mb-3">
                    <span>Our</span>Latest Courses </h3>
                <div class="row choose-main ">
                    <div class="col-lg-6 galsses-grid-right">
                        <h5>
                            <span class="post-color">One</span></h5>
                        <h4 class="post my-3">How to Start an Amazon
FBA Store on a Tight Budget</h4>
                ...
                <div class="row choose-main my-lg-5 my-3">
                    ...
                    <div class="col-lg-6 galsses-grid-right mt-5">
                        ...
                        <h5>
                            <span class="post-color">Two</span></h5>
                        <h4 class="post my-3">The Ultimate Drawing Course
