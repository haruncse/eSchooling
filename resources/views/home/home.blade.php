...
<head>
    <title>Collegian Education Category Bootstrap responsive Web Template | Home :: w3layouts</title>
            ...
            <div class="inner-sec-wthree-w3ls py-md-5 py-4">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 aboutright">
                        ...
                        <a href="/about" class="btn btn-sm animated-button victoria-two">Read More</a>
                    </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row footer-grids">
                    <div class="col-lg-4 col-md-6 footer-grid text-left">
                        <div class="footer-logo">
                            <h3 class="mb-3"><a class="logo" href="/">Collegian</a></h3>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="{{ route('register') }}"  method="POST" >
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="validationDefault01" name="name" value="{{ old('name') }}" required autofocus>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" id="validationDefault02" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                                 @if ($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password2" placeholder="" name="password_confirmation" required>
                            </div>
                            <div class="form-group">
                                <label>Type</label>
